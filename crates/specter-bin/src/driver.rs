...
//! name-keyed diff, apply via `Input::ConfigDiff` (the engine resolves
//! names to ids against its own registries), rotate `current_config`.
//! All on the engine thread — no Mutex.
